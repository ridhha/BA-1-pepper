...
T = float(input("T = "))
s = 5.6697e-8
# A comprendre: --> Voir feuille Reynold + Nusselt !!! --> Besoin du Débit!!!
l = 1
H = 0.1
a = 27e-6
g = 9.81
...
solutions_Bloc3()
print("La température du plastique est de ", solutions_Bloc3[0])
print("La température du sol est de ", solutions_Bloc3[1])
print("La Pression par mètre carré est de ", solutions_Bloc3[2])
